...
<body class="racing-gradient min-h-screen">
                ...
                <div class="text-center">
                    ...
                    <div class="space-y-5 mb-6">
                        ...
                        <div class="bg-white/10 rounded-lg p-3">
                            ...
                            <div class="text-xl md:text-2xl font-bold text-blue-400 racing-font" x-text="`${correctAnswers}/${questionCount}`"></div>
                        </div>
                    </div>
   ...
   this.notyf = new Notyf({
    ...
    onDismiss: (notification) => {
        console.log('Notifikasi ditutup:', notification.options.type);
    }
});
                        ...
                        this.spawnOpponentCar = function() {
                            if (opponentCars.length < 2) {
                                ...
                                if (availableLanes.length > 0) {
                                    ...
                                    car.setData('speed', 250 + Math.random() * 100);
